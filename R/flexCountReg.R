...
#'
#' flexCountReg is a wrapper function for estimating a variety of count regression models. This is the main function in the package. These include multiple count distributions with options for random parameters.
#'
#' @name flexCountReg
...
#' @param correlated if the random parameters should be correlated (\code{correlated = FALSE} results in uncorrelated random coefficients, \code{correlated = TRUE} results in correlated random coefficients),
