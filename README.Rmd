...
- `poisLind.re` estimates the Random Effects Poisson-Lindley regression model (panel model).
...
- `rppLind` estimates the random parameters Poisson-Lindley regression model.
