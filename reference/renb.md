...
#> 1 (Intercept)        -9.35        1.46     -6.38     0        -12.2       -6.48 
#> 2 lnaadt              0.965       0.174     5.54     0          0.624      1.31 
#> 3 speed50            -0.988       0.359    -2.76     0.006     -1.69      -0.285
#> 4 ShouldWidth04      -0.415       0.278    -1.49     0.135     -0.96       0.129
#> 5 AADTover10k        -0.868       0.509    -1.70     0.088     -1.86       0.129
#> 6 ln(a-1)             2.91       NA        NA       NA         NA         NA    
#> 7 ln(b)               0.619       0.322     1.92     0.055     -0.012      1.25 
